...
export default function Yield(): JSX.Element {
    ...
    return (
        <>
            <Helmet>
                <title>{i18n._(t`Yield`)} | SWTCH</title>
            ...
            {farm.type === 'SLP' && (
                <Paper className="bg-dark-800">
                    ...
                    >
                        ...
                        <div className="hidden md:block text-sm sm:text-base ml-4 text-gray-500">{'SWTCH & MATIC'}</div>
                        ...
                        <div className="md:col-span-4 hidden md:flex flex-row space-x-2 justify-start items-center ml-4">
                            ...
                            <div className="flex flex-col pl-2 space-y-1">
                                <div className="text-gray-500 text-xs">
                                    {formattedNum(farm.sushiRewardPerDay)} SWTCH / day
                                </div>
                                <div className="text-gray-500 text-xs">
